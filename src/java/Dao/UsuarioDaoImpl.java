 ...
 private Connection cn;
    ...
    public Usuario validate(String user, String passw) {
       ...
       try {
            u = new Usuario();
            p = new Persona();
            String hashedPasssword = u.HashPassword(passw);
            ...
            System.out.println("no se puedo validar el usuario");
        } finally {
            if (cn!=null) {
                try {
                } catch (Exception ex) {
...
// implemnetacion del insert del usuario y la persona, ademas d ela validación del usuario
